...
function toggleSubNav1() {
    var subNavContent1 = document.getElementById("subNavContent1");
    if (subNavContent1.style.display === "block") {
        subNavContent1.style.display = "none";
    } else {
        subNavContent1.style.display = "block";
    }
}
